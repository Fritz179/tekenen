...
//     Array { data_type: String, value: String },
//     Object
// }

// type Value = (String, String);

// fn resolve(shape: Value, base: bool) -> String {
//     format!("pub struct PreloadStructure {}
...
// pub fn preload_array(shape: Vec<Value>) -> Value {
//     let len = shape.len();

//     let mut data_type = format!("[{}; {len}]", shape[0].0);
//     let mut value = "[\n".to_owned();

//     for (_, inner_value) in shape {
//         value.push_str(&format!("{inner_value}, "));
//     }
...
pub fn preload_array(data: Vec<Preloaded>) -> Preloaded {
    let len = data.len();
    assert!(len > 1, "No preloaded data in array");
